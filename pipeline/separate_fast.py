...
# Code-Source: https://github.com/open-mmlab/Amphion/blob/main/preprocessors/Emilia/models/separate_fast.py
...
if 'CUDAExecutionProvider' not in ort.get_available_providers():
    print("⚠️ Warning: ONNXRuntime GPU provider not available. Install with:")
    print("   pip install --upgrade --force-reinstall onnxruntime-gpu==<compatible_with_your_cuda_version>")
